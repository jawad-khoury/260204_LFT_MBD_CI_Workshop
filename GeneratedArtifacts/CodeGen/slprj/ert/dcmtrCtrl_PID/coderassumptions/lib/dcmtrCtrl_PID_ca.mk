...
## Generated on : Tue Jan 06 17:02:43 2026
...
COMPILER_COMMAND_FILE     = dcmtrCtrl_PID_ca_comp.rsp
CMD_FILE                  = dcmtrCtrl_PID_ca.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = dcmtrCtrl_PID_ca.lib
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/dcmtrCtrl_PID_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj dcmtrCtrl_PID_ca.obj
...
%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
dcmtrCtrl_PID_ca.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/dcmtrCtrl_PID_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"
