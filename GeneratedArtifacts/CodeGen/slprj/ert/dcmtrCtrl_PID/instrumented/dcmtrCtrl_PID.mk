...
MODELLIB                  = dcmtrCtrl_PID_rtwlib.lib
...
PRODUCT = ./dcmtrCtrl_PID_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/dcmtrCtrl_PID/instrumented/dcmtrCtrl_PID.c
...
dcmtrCtrl_PID.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/instrumented/dcmtrCtrl_PID.c
	$(CC) $(CFLAGS) -o "$@" "$<"
