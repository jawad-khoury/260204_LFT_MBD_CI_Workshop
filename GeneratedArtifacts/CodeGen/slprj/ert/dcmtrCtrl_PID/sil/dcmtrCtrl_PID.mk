...
## Generated on : Tue Jan 06 17:02:45 2026
## Final product: ./dcmtrCtrl_PID.exe
...
MODELREF_LINK_RSPFILE     = dcmtrCtrl_PID_ref.rsp
COMPILER_COMMAND_FILE     = dcmtrCtrl_PID_comp.rsp
CMD_FILE                  = dcmtrCtrl_PID.rsp
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0 -DPROFILING_DEFINE_UINT64_TIMER_TYPE -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
DEFINES_STANDARD = -DMODEL=dcmtrCtrl_PID -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/xil_interface.c $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/sil_main.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/target_io.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/xil_instrumentation.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c
...
MODELREF_LIBS = C:/Users/jkhoury/MATLAB_AE/260204_VVTestingWorkshop/dc-motor-with-pid-control/GeneratedArtifacts/CodeGen/slprj/ert/dcmtrCtrl_PID/instrumented/dcmtrCtrl_PID_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/dcmtrCtrl_PID/coderassumptions/lib/dcmtrCtrl_PID_ca.lib
...
%.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
xil_interface.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/slprj/ert/dcmtrCtrl_PID/sil/xil_instrumentation.c
	$(CC) $(CFLAGS) -o "$@" "$<"
